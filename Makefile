...
HTTPS_GIT := https://github.com/mydexchain/iavl.git

PDFFLAGS := -pdf --nodefraction=0.1
CMDFLAGS := -ldflags -X TENDERMINT_IAVL_COLORS_ON=on 
LDFLAGS := -ldflags "-X github.com/mydexchain/iavl.Version=$(VERSION) -X github.com/mydexchain/iavl.Commit=$(COMMIT) -X github.com/mydexchain/iavl.Branch=$(BRANCH)"
